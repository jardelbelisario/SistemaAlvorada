...
class Cursos extends Controller
{
    ...
    {
        $contentheader_title =  "LISTAGEM DE CURSOS";
        $contentheader_description = "Todos os cursos cadastrados no Sistema Alvorada.";

        return view('cursos.listagem', compact('contentheader_title','contentheader_description'));
    ...
    public function store(Request $request)
    {
        ...
        return redirect('/home/cursos/cadastrar');
    }
